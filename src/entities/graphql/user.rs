...
impl Model {
	...
	async fn following(&self) -> Vec<String> { // TODO: return a vec of Planets instead
	...
	async fn memberOf(&self) -> Vec<String> { // TODO: return a vec of Planets instead
		vec![]
	}
	...
	// TODO: guard behind authentication
	async fn blockedUsers(&self) -> Vec<String> { // TODO: return a vec of Users instead
		self.blocked.clone()
	}
